...
| `paths` | [CorsPathConfig\[\]](../se/../config/io_helidon_webserver_cors_CorsPathConfig.md) |   | Per path configuration. Default path is added, unless addDefaults() is set to `false`. |
