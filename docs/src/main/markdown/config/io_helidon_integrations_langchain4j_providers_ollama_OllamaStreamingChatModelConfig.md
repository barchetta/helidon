# OllamaStreamingChatModelConfig (integrations.langchain4j.providers.ollama) Configuration

Type: [io.helidon.integrations.langchain4j.providers.ollama.OllamaStreamingChatModelConfig](/apidocs/io.helidon.integrations.langchain4j.providers.ollama/io/helidon/integrations/langchain4j/providers/ollama/OllamaStreamingChatModelConfig.html)
...
| `enabled` | boolean | `true` | If set to `false`, OllamaStreamingChatModel will not be available even if configured. |
