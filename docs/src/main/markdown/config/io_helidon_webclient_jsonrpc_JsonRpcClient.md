...
Type: [io.helidon.webclient.jsonrpc.JsonRpcClient](/apidocs/io.helidon.webclient.jsonrpc/io/helidon/webclient/jsonrpc/JsonRpcClient.html)
...
<td style="text-align: left;"><p><a href="../config/../config/io_helidon_webclient_jsonrpc_JsonRpcClientProtocolConfig.xml">JsonRpcClientProtocolConfig</a></p></td>
<td style="text-align: left;"><p><code>create()</code></p></td>
<td style="text-align: left;"><p>JSON-RPC specific configuration.</p></td>
</tr>
<tr>
