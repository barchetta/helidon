# Http1Client (webclient.http1) Configuration

Type: [io.helidon.webclient.http1.Http1Client](/apidocs/io.helidon.webclient.http1/io/helidon/webclient/http1/Http1Client.html)
