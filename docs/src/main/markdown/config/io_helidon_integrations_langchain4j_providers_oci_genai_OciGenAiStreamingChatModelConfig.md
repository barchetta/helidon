# OciGenAiStreamingChatModelConfig (integrations.langchain4j.providers.oci.genai) Configuration

Type: [io.helidon.integrations.langchain4j.providers.oci.genai.OciGenAiStreamingChatModelConfig](/apidocs/io.helidon.integrations.langchain4j.providers.oraclegenai/io/helidon/integrations/langchain4j/providers/oci/genai/OciGenAiStreamingChatModelConfig.html)
...
| `enabled` | boolean | `true` | If set to `false`, OciGenAiStreamingChatModel will not be available even if configured. |
