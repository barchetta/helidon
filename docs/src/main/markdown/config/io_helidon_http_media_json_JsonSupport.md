# JsonSupport (http.media.json) Configuration

Type: [io.helidon.http.media.json.JsonSupport](/apidocs/io.helidon.http.media.json/io/helidon/http/media/json/JsonSupport.html)
