...
Type: [io.helidon.webclient.grpc.GrpcClient](/apidocs/io.helidon.webclient.grpc/io/helidon/webclient/grpc/GrpcClient.html)
...
<td style="text-align: left;"><p>Whether to collect metrics for gRPC client calls.</p></td>
</tr>
<tr>
...
<tr>
<td style="text-align: left;"><p><code>grpc-services</code></p></td>
<td style="text-align: left;"><p>io.helidon.webclient.grpc.spi.GrpcClientService[] (service provider interface)</p></td>
<td style="text-align: left;"><p> </p></td>
<td style="text-align: left;"><p>gRPC client services. A gRPC service needs to be explicitly added to be enabled given that <code>discoveredServices</code> is <code>false</code>.</p></td>
</tr>
<tr>
...
<tr>
<td style="text-align: left;"><p><code>protocol-config</code></p></td>
<td style="text-align: left;"><p><a href="../config/../config/io_helidon_webclient_grpc_GrpcClientProtocolConfig.xml">GrpcClientProtocolConfig</a></p></td>
<td style="text-align: left;"><p><code>create()</code></p></td>
<td style="text-align: left;"><p>gRPC specific configuration.</p></td>
</tr>
<tr>
