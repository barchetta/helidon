...
Type: [io.helidon.data.sql.datasource.ucp.UcpDataSourceConfig](/apidocs/io.helidon.data.sql.datasource.ucp/io/helidon/data/sql/datasource/ucp/UcpDataSourceConfig.html)
