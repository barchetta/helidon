...
We use Jaeger OpenTelemetry Tracing client to integrate with Jaeger tracer.

## Maven Coordinates

To enable Jaeger Tracing, add the following dependency to your project’s `pom.xml` (see [Managing Dependencies](../../about/managing-dependencies.md)).
...
Type: [io.helidon.tracing.Tracer]({javadoc-base-url}/io.helidon.tracing/io/helidon/tracing/Tracer.md)
