...
The archetype generates a Maven project in your current directory, (for example, `helidon-quickstart-{project-tag}-{flavor-lc}`). Change into this directory and build.
...
Add to the configuration file following LangChain4j configuration for OpenAI provider.
