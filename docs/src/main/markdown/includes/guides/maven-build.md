...
Helidon examples and projects generated using the [Helidon Quickstart](../../includes/guides/../../{flavor-lc}/guides/quickstart.md) use a Helidon application POM as their parent. This parent POM provides the following:
...
If you want to use your own parent POM, then take a look at the [standalone quickstart example]({helidon-github-examples-url}/quickstarts/helidon-standalone-quickstart-{flavor-lc}). This example has a standalone POM that you can pattern your own application POM after.

For more details on Helidon application POMs see the [Helidon’s Application POMS]({helidon-github-tree-url}/docs-internal/application-pom.md)
...
1.  jlink-image: Build a [custom runtime Java image](../../includes/guides/../../{flavor-lc}/guides/jlink-image.md).

2.  native-image: Build a [GraalVM native image](../../includes/guides/../../{flavor-lc}/guides/graalnative.md). Note: this capability is now provided via the [Maven plugin for GraalVM Native Image](https://graalvm.github.io/native-build-tools/latest/maven-plugin.html)
