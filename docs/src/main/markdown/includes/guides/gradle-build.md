...
The Helidon [Quickstart Example]({helidon-github-examples-url}/quickstarts/helidon-quickstart-{flavor-lc}) contains a `build.gradle` file that you can use as an example for building your Helidon application using Gradle.
