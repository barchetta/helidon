...
The [OpenAPI specification]({openapi-spec-url}) provides a standard way to express RESTful APIs.

Separately, the [OpenAPI generator]({openapi-generator-tool-site-url}) project has created a powerful code generator tool which accepts an OpenAPI document and generates client and server code for many languages and frameworks. The Helidon team contributes to this tool to ensure that it provides strong support for Helidon {flavor-uc} clients and servers. As a result, you can use the generator to create code that fits smoothly into your Helidon applications.
...
- [Helidon client generator options]({openapi-generator-tool-generators-docs-url}/java-helidon-client.md) and

- [Helidon server generator options]({openapi-generator-tool-generators-docs-url}/java-helidon-server.md)
...
As you generate a Helidon {flavor-uc} *server*, you can choose whether you want Java interfaces or classes to represent the RESTful API endpoints.
...
When you generate a Helidon {flavor-uc} server, the generator creates a separate interface or class for each API your service *exposes*. You implement each interface or extend each class to add your business logic for that API.

When you generate a Helidon {flavor-uc} client, the generated code contains a separate API class for each distinct API your code might *invoke*.
...
- [OpenAPI Generator Official Website]({openapi-generator-tool-site-url})

- [OpenAPI Generator GitHub Repository]({openapi-generator-tool-base-url})
