...
Type: [io.helidon.webserver.observe.ObserveFeature]({javadoc-base-url}/io.helidon.webserver.observe/io/helidon/webserver/observe/ObserveFeature.md)
...
<td style="text-align: left;"><p><a href="../includes/../config/io_helidon_cors_CrossOriginConfig.xml">CrossOriginConfig</a></p></td>
...
<p>Such as:</p>
<ul>
<li><p><a href="../includes/../config/io_helidon_webserver_observe_log_LogObserver.xml">log (LogObserver)</a></p></li>
<li><p><a href="../includes/../config/io_helidon_webserver_observe_tracing_TracingObserver.xml">tracing (TracingObserver)</a></p></li>
<li><p><a href="../includes/../config/io_helidon_webserver_observe_config_ConfigObserver.xml">config (ConfigObserver)</a></p></li>
<li><p><a href="../includes/../config/io_helidon_webserver_observe_info_InfoObserver.xml">info (InfoObserver)</a></p></li>
<li><p><a href="../includes/../config/io_helidon_webserver_observe_metrics_MetricsObserver.xml">metrics (MetricsObserver)</a></p></li>
<li><p><a href="../includes/../config/io_helidon_webserver_observe_health_HealthObserver.xml">health (HealthObserver)</a></p></li>
</ul></td>
