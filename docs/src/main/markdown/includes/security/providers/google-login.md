...
Type: [io.helidon.security.providers.google.login.GoogleTokenProvider]({javadoc-base-url}/io.helidon.security.providers.google.login/io/helidon/security/providers/google/login/GoogleTokenProvider.md)
