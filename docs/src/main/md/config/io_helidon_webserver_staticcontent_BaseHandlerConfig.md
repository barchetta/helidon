Type:
[io.helidon.webserver.staticcontent.BaseHandlerConfig](/apidocs/io.helidon.webserver.staticcontent/io/helidon/webserver/staticcontent/BaseHandlerConfig.html)
