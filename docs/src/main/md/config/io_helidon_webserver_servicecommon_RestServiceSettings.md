Type:
[io.helidon.webserver.servicecommon.RestServiceSettings](/apidocs/io.helidon.webserver.servicecommon/io/helidon/webserver/servicecommon/RestServiceSettings.html)
