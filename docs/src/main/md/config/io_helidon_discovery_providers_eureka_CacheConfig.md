Type:
[io.helidon.discovery.providers.eureka.CacheConfig](/apidocs/io.helidon.discovery.providers.eureka/io/helidon/discovery/providers/eureka/CacheConfig.html)
...
<td style="text-align: left;"><p>Whether the state of the cache should
...
<td style="text-align: left;"><p>Whether to defer immediate cache
...
<td style="text-align: left;"><p>boolean</p></td>
<td style="text-align: left;"><p><code>true</code></p></td>
<td style="text-align: left;"><p>Whether a local cache of Eureka
...
<td
style="text-align: left;"><p><code>Eureka registry fetch thread</code></p></td>
<td style="text-align: left;"><p>The name of the Thread used to retrieve
...
<td style="text-align: left;"><p>The time between retrievals of service
