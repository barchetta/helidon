Type:
[io.helidon.webserver.observe.log.LogStreamConfig](/apidocs/io.helidon.webserver.observe.log/io/helidon/webserver/observe/log/LogStreamConfig.html)
...
<td
style="text-align: left;"><p><code>@io.helidon.http.HttpMediaTypes@.PLAINTEXT_UTF_8</code></p></td>
...
<tr>
<td
style="text-align: left;"><p><code>idle-message-timeout</code></p></td>
<td style="text-align: left;"><p>Duration</p></td>
<td style="text-align: left;"><p><code>PT5S</code></p></td>
<td style="text-align: left;"><p>How long to wait before we send the
...
<td style="text-align: left;"><p>String sent when there are no log
...
<td style="text-align: left;"><p>Length of the in-memory queue that
