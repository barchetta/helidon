Type:
[io.helidon.integrations.langchain4j.providers.oci.genai.OciGenAiCohereChatModelConfig](/apidocs/io.helidon.integrations.langchain4j.providers.oci.genai/io/helidon/integrations/langchain4j/providers/oci/genai/OciGenAiCohereChatModelConfig.html)

This is a standalone configuration type, prefix from configuration root:
`langchain4j.oci-gen-ai-cohere.chat-model`
...
| `enabled` | boolean |   | If set to `false` (default), OciGenAiCohereChatModel will not be available even if configured. |
