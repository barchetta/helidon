Type:
[io.helidon.integrations.oci.metrics.OciMetricsSupport](/apidocs/io.helidon.integrations.oci.metrics/io/helidon/integrations/oci/metrics/OciMetricsSupport.html)
...
<td style="text-align: left;"><p>Sets the delay interval if metrics are
...
<td style="text-align: left;"><p>Sets the maximum no. of metrics to send
...
<td style="text-align: left;"><p>Sets the delay interval between metric
posting (defaults to DEFAULT_SCHEDULER_DELAY).</p></td>
</tr>
<tr>
<td
style="text-align: left;"><p><code>description-enabled</code></p></td>
<td style="text-align: left;"><p>boolean</p></td>
<td style="text-align: left;"><p><code>true</code></p></td>
<td style="text-align: left;"><p>Sets whether the description should be
enabled or not.</p>
...
<td style="text-align: left;"><p>boolean</p></td>
<td style="text-align: left;"><p><code>true</code></p></td>
<td style="text-align: left;"><p>Sets whether metrics transmission to
OCI is enabled.</p>
<pre><code>Defaults to `true`.</code></pre></td>
</tr>
<tr>
...
<td style="text-align: left;"><p>long</p></td>
<td style="text-align: left;"><p><code>1</code></p></td>
<td style="text-align: left;"><p>Sets the initial delay before metrics
...
<tr>
<td
style="text-align: left;"><p><code>scheduling-time-unit</code></p></td>
...
<td style="text-align: left;"><p>Sets the time unit applied to the
...
<td style="text-align: left;"><p>Sets which metrics scopes (e.g., base,
