Type:
[io.helidon.integrations.langchain4j.providers.ollama.OllamaChatModelConfig](/apidocs/io.helidon.integrations.langchain4j.providers.ollama/io/helidon/integrations/langchain4j/providers/ollama/OllamaChatModelConfig.html)
...
| `enabled` | boolean |   | If set to `false` (default), OllamaChatModel will not be available even if configured. |
