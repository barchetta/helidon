Type:
[io.helidon.webserver.staticcontent.StaticContentFeature](/apidocs/io.helidon.webserver.staticcontent/io/helidon/webserver/staticcontent/StaticContentFeature.html)
...
href="../config/io_helidon_webserver_staticcontent_ClasspathHandlerConfig.xml">ClasspathHandlerConfig[]</a></p></td>
<td style="text-align: left;"><p> </p></td>
<td style="text-align: left;"><p>List of classpath based static content
handlers.</p></td>
</tr>
<tr>
...
<td style="text-align: left;"><p>Whether this feature is enabled,
...
<td style="text-align: left;"><p> </p></td>
<td style="text-align: left;"><p>Memory cache shared by the whole
...
<td style="text-align: left;"><p><a
href="../config/io_helidon_webserver_staticcontent_FileSystemHandlerConfig.xml">FileSystemHandlerConfig[]</a></p></td>
<td style="text-align: left;"><p> </p></td>
<td style="text-align: left;"><p>List of file system based static
...
<td style="text-align: left;"><p> </p></td>
<td style="text-align: left;"><p>Temporary storage to use across all
...
<td style="text-align: left;"><p>Weight of the static content feature.
...
<td style="text-align: left;"><p>string</p></td>
<td style="text-align: left;"><p> </p></td>
<td style="text-align: left;"><p>Welcome-file name. Default for all
