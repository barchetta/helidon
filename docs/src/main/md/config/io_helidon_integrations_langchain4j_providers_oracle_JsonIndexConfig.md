Type:
[io.helidon.integrations.langchain4j.providers.oracle.JsonIndexConfig](/apidocs/io.helidon.integrations.langchain4j.providers.oracle/io/helidon/integrations/langchain4j/providers/oracle/JsonIndexConfig.html)

This is a standalone configuration type, prefix from configuration root:
`langchain4j.oracle.embedding-store.json-index`
