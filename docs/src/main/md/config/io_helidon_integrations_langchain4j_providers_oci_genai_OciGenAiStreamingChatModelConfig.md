Type:
[io.helidon.integrations.langchain4j.providers.oci.genai.OciGenAiStreamingChatModelConfig](/apidocs/io.helidon.integrations.langchain4j.providers.oci.genai/io/helidon/integrations/langchain4j/providers/oci/genai/OciGenAiStreamingChatModelConfig.html)

This is a standalone configuration type, prefix from configuration root:
`langchain4j.oci-gen-ai.streaming-chat-model`
...
| `enabled` | boolean |   | If set to `false` (default), OciGenAiStreamingChatModel will not be available even if configured. |
