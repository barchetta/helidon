Type:
[io.helidon.faulttolerance.Retry](/apidocs/io.helidon.faulttolerance/io/helidon/faulttolerance/Retry.html)
...
<td style="text-align: left;"><p>Number of calls (first try +
retries).</p></td>
</tr>
<tr>
...
<td style="text-align: left;"><p>Base delay between try and retry.
...
<td style="text-align: left;"><p>Delay retry policy factor. If
...
<td style="text-align: left;"><p>Jitter for Retry.JitterRetryPolicy. If
...
<td style="text-align: left;"><p>Overall timeout of all retries
combined.</p></td>
</tr>
</tbody>
</table>
