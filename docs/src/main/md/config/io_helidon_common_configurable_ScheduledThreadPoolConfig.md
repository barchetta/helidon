Type:
[io.helidon.common.configurable.ScheduledThreadPoolSupplier](/apidocs/io.helidon.common.configurable/io/helidon/common/configurable/ScheduledThreadPoolSupplier.html)
