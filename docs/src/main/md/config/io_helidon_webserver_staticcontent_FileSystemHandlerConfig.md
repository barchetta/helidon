Type:
[io.helidon.webserver.staticcontent.FileSystemHandlerConfig](/apidocs/io.helidon.webserver.staticcontent/io/helidon/webserver/staticcontent/FileSystemHandlerConfig.html)
...
<td style="text-align: left;"><p> </p></td>
<td style="text-align: left;"><p>The directory (or a single file) that
