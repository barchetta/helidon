Type:
[io.helidon.webserver.concurrency.limits.LimitsFeature](/apidocs/io.helidon.webserver.concurrency.limits/io/helidon/webserver/concurrency/limits/LimitsFeature.html)
...
<td style="text-align: left;"><p>Weight of the context feature. As it is
