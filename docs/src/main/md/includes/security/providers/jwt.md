...
Type:
[io.helidon.security.providers.jwt.JwtProvider]({javadoc-base-url}/io.helidon.security.providers.jwt/io/helidon/security/providers/jwt/JwtProvider.html)
...
See the
[example]({helidon-github-examples-url}/security/outbound-override) on
GitHub.
