...
Type:
[io.helidon.security.providers.google.login.GoogleTokenProvider]({javadoc-base-url}/io.helidon.security.providers.google.login/io/helidon/security/providers/google/login/GoogleTokenProvider.html)
...
See the [example]({helidon-github-examples-url}/security/google-login)
on GitHub.
