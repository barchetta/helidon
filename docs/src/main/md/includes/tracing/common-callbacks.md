...
it can do. See the
[`SpanListener`]({tracing-javadoc-base-url}/io/helidon/tracing/SpanListener.html)
...
[`SpanListener.ForbiddenOperationException`]({tracing-javadoc-base-url}/io/helidon/tracing/SpanListener.ForbiddenOperationException.html)
and Helidon then logs a `WARNING` message describing the invalid
operation invocation.

| Tracing type | Changes allowed |
|----|----|
| [`Span.Builder`]({tracing-javadoc-base-url}/io/helidon/tracing/Span.Builder.html) | Add tags |
| [`Span`]({tracing-javadoc-base-url}/io/helidon/tracing/Span.html) | Retrieve and update baggage, add events, add tags |
| [`Scope`]({tracing-javadoc-base-url}/io/helidon/tracing/Scope.html) | none |
...
[`io.helidon.tracing.Span.Builder`]({tracing-javadoc-base-url}/io/helidon/tracing/Span.Builder.html)
Operations
...
[`io.helidon.tracing.Span`]({tracing-javadoc-base-url}/io/helidon/tracing/Span.html)
Operations
...
[`io.helidon.tracing.Scope`]({tracing-javadoc-base-url}/io/helidon/tracing/Scope.html)
Operations
...
[`io.helidon.tracing.SpanContext`]({tracing-javadoc-base-url}/io/helidon/tracing/SpanContext.html)
Operations

## Adding a Listener

### Explicitly Registering a Listener on a [`Tracer`]({tracing-javadoc-base-url}/io/helidon/tracing/Tracer.html)
