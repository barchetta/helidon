...
Feature](#_server_features) instead.
...
webserver, other routes like `Http2Route` for [HTTP/2](#_http2_support)
...
Options](#_configuration_options), configuration key `features`.
...
Type:
[io.helidon.http.media.jsonb.JsonbSupport](/apidocs/io.helidon.http.media.jsonb/io/helidon/http/media/jsonb/JsonbSupport.html)
...
Type:
[io.helidon.http.encoding.ContentEncodingContext](/apidocs/io.helidon.http.encoding/io/helidon/http/encoding/ContentEncodingContext.html)
...
- [Helidon WebServer
  JavaDoc](/apidocs/io.helidon.webserver/module-summary.html)

- [Helidon WebServer Static Content
  JavaDoc](/apidocs/io.helidon.webserver.staticcontent/module-summary.html)

- [Helidon JSON-B Support
  JavaDoc](/apidocs/io.helidon.http.media.jsonp/module-summary.html)

- [Helidon JSON-P Support
  JavaDoc](/apidocs/io.helidon.http.media.jsonb/module-summary.html)

- [Helidon Jackson Support
  JavaDoc](/apidocs/io.helidon.http.media.jackson/module-summary.html)
