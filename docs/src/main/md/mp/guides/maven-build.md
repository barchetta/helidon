...
example](https://github.com/helidon-io/helidon-examples/tree/helidon-4.x/examples/quickstarts/helidon-standalone-quickstart-mp).
...
2.  native-image: Build a [GraalVM native
    image](../../mp/guides/graalnative.md).
