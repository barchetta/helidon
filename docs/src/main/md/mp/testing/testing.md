...
JAXRS (Jersey) support can be added easily using
...
The CDI scope used by the test instance follows the lifecyle defined by
...
To enable mock mupport add the following dependency to your project’s
pom.xml.
...
- [Official blog article about Helidon and JUnit
  usage](https://medium.com/helidon/testing-helidon-9df2ea14e22)
