...
The test instance lifecycle is a pseudo singleton that follows the
lifecycle of the CDI container.
...
1.  `org.testng.annotations.Test` is not inheritable and should be
    placed on methods
